...
\begin{enumerate}[noitemsep]
	\litem{Classificazione}la funzione è una funzione razionale\index{Funzione!razionale}. 
...
\begin{figure}
	...
	\centering
	\includestandalone[width=8.5cm]{dominio/disequazione1}
	\caption{Segno funzione}
	\label[graf]{fig:Drazionale1}
\end{figure}
\begin{funzionet}{Razionale}{razio6}
	\includestandalone[width=\linewidth]{dominio/razio6}
	\tcblower
	\begin{itemize}
		\item $y=x^4-x^2$
		\item Dominio $\R$
...
\begin{figure}
	\captionsetup{name=Grafico}
	\centering
	\includestandalone[width=8.5cm]{dominio/disequazione2}
	\caption{Segno funzione}
	\label[graf]{fig:Drazionale2}
\end{figure}
\begin{funzionet}{Razionale}{razio1}
\includestandalone[width=\linewidth]{dominio/razio1}
	\tcblower
	\begin{itemize}
		\item $y=2x+1$
		\item Dominio $\R$
...
\end{esempiot}
\begin{enumerate}[noitemsep]
	\litem{Classificazione}la funzione è una funzione razionale\index{Funzione!razionale!fratta}.
...
\begin{figure}
	\captionsetup{name=Grafico}
	\centering
	\includestandalone[width=8.5cm]{dominio/disequazione4}
	\caption{Segno funzione}
	\label[graf]{fig:Drazionale4}
\end{figure}
\begin{funzionet}{Razionale fratta}{razio3}
	\includestandalone[width=\textwidth]{dominio/razio3}
	\tcblower
	\begin{itemize}
...
\begin{figure}
	\captionsetup{name=Grafico}
	\centering
	\includestandalone[width=8.5cm]{dominio/disequazione7}
	\caption{Segno funzione}
	\label[graf]{fig:Drazionale7}
\end{figure}
\begin{funzionet}{Razionale fratta}{razio7}
	\includestandalone[width=\textwidth]{dominio/razio7}
	\tcblower
	\begin{itemize}
...
\begin{figure}
	\captionsetup{name=Grafico}
	\centering
	\includestandalone[width=8.5cm]{dominio/disequazione8}
	\caption{Segno funzione}
	\label[graf]{fig:Drazionale8}
\end{figure}
\begin{funzionet}{Razionale fratta}{razio8}
	\includestandalone[width=\textwidth]{dominio/razio8}
	\tcblower
	\begin{itemize}
